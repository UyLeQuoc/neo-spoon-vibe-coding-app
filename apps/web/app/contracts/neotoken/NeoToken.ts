...
export class NeoToken {
  ...
  async confirmTransferEvent(txId: string): Promise<void> {
    ...
    this.config.eventListener.confirmTransaction(txResult, { contract: this.config.scriptHash, eventname: 'Transfer' })
  }
  ...
  async confirmCandidateStateChangedEvent(txId: string): Promise<void> {
    ...
    this.config.eventListener.confirmTransaction(txResult, {
      ...
      eventname: 'CandidateStateChanged'
    })
  }
  ...
  async confirmVoteEvent(txId: string): Promise<void> {
    ...
    const txResult = await this.config.eventListener.waitForApplicationLog(txId)
    this.config.eventListener.confirmTransaction(txResult, { contract: this.config.scriptHash, eventname: 'Vote' })
  }
