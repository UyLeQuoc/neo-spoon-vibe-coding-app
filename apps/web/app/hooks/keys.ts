...
export const queryKeys = {
  ...
  storageCost: (fileSize: number, epochs: number) =>
    ['storageCost', fileSize, epochs] as const,
  ...
  sandbox: {
    ...
    status: (sandboxId: string | null) =>
      ['sandbox', sandboxId, 'status'] as const,
    command: (sandboxId: string | null, cmdId: string | null) =>
      ['sandbox', sandboxId, 'cmd', cmdId] as const,
    commands: (sandboxId: string | null) =>
      ['sandbox', sandboxId, 'commands'] as const,
