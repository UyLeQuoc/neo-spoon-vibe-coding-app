    ...
    <div style={{ padding: '40px', fontFamily: 'monospace', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '10px' }}>
          <button onClick={transferGas} disabled={!isConnected || isLoading} style={buttonStyle(isConnected, '#FF9800')}>
            💸 Transfer 1 GAS
          </button>
          <button onClick={transferGasWithExtraFee} disabled={!isConnected || isLoading} style={buttonStyle(isConnected, '#FF9800')}>
            💸+ Transfer GAS (Extra Fee)
          </button>
          <button onClick={multiInvokeFailing} disabled={!isConnected || isLoading} style={buttonStyle(isConnected, '#f44336')}>
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px' }}>
          <button onClick={signAndVerify} disabled={!isConnected || isLoading} style={buttonStyle(isConnected, '#9C27B0')}>
            ✍️ Sign & Verify
          </button>
          <button onClick={signWithoutSaltAndVerify} disabled={!isConnected || isLoading} style={buttonStyle(isConnected, '#9C27B0')}>
            ✍️ Sign Without Salt
          </button>
